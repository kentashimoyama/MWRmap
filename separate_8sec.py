...
class SeparateMwr():
    ...
    def sep_8sec(self, filename):
        ...
        end_time = start_time + self.timeseg
        ...
        for i, data in enumerate(split_data):
            print(f"processing separate mwr {i}/{len(split_data)} ...")
            # 0列目と1列目のデータを抽出する
...
if __name__ == '__main__':
    ...
    # ampazi = False
    # amp = True
    # input_filename_list = [r"C:\Users\kenta shimoyama\Documents\amanolab\melco\generate_mvp\temp_using\mwr+aqloc/symbols_vison_left_extracted_15_80azi.csv", r"C:\Users\kenta shimoyama\Documents\amanolab\melco\generate_mvp\temp_using\mwr+aqloc/symbols_vison_right_extracted_15_80azi.csv"]
